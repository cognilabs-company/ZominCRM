...
const translations: TranslationMap = {
  ...
  "cart.map_description": { uz: "Xaritada yetkazib berish joyini tanlang.", ru: "Выберите точку доставки на карте.", en: "Choose the delivery point on the map." },
  ...
  "cart.map_select_hint": { uz: "Joyni o'zgartirish uchun xaritada bosing.", ru: "Нажмите на карту, чтобы изменить точку.", en: "Tap the map to move the pin." },
  ...
  "cart.map_selected_empty": { uz: "Xaritadan joy tanlang yoki manzilni qo'lda yozing.", ru: "Выберите точку на карте или введите адрес вручную.", en: "Choose a point on the map or enter the address manually." },
