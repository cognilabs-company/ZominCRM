...
const translations: TranslationMap = {
  ...
  "layout.telegram_verified": { uz: "Buyurtma berish uchun sahifa tayyor.", ru: "Страница готова для заказа.", en: "Your order page is ready." },
  "layout.preview_shell": { uz: "To'liq foydalanish uchun Telegram ichida oching.", ru: "Для полного использования откройте внутри Telegram.", en: "Open inside Telegram for full access." },
  ...
  "layout.telegram_detected": { uz: "Telegram orqali ochildi.", ru: "Открыто через Telegram.", en: "Opened through Telegram." },
  "layout.telegram_missing": { uz: "To'liq ishlashi uchun Telegram ichida oching.", ru: "Для полной работы откройте в Telegram.", en: "Open in Telegram for full access." },
  ...
  "home.quick.cart.description": { uz: "Savatchani tekshirib, manzilni tanlang va davom eting.", ru: "Проверьте корзину, выберите адрес и продолжайте.", en: "Review your cart, choose the address, and continue." },
  ...
  "products.unauth_subtitle": { uz: "Mahsulotlarni ko'rish uchun Telegram ichida oching.", ru: "Откройте внутри Telegram, чтобы увидеть товары.", en: "Open inside Telegram to view products." },
  ...
  "cart.subtitle": { uz: "Mahsulotlarni tekshiring, manzilni tanlang va davom eting.", ru: "Проверьте товары, выберите адрес и продолжайте.", en: "Review your items, choose the address, and continue." },
  "cart.preview": { uz: "Davom etish", ru: "Продолжить", en: "Continue" },
  "cart.empty": { uz: "Savatcha hozircha bo'sh. Avval mahsulot qo'shing.", ru: "Корзина пока пуста. Сначала добавьте товары.", en: "Your cart is empty. Add products first." },
  ...
  "cart.delivery_address_placeholder": { uz: "Mahalla, ko'cha, uy raqamini yozing", ru: "Укажите район, улицу и дом", en: "Enter area, street, and house number" },
  ...
  "cart.map_select_hint": { uz: "Pinni qo'yish uchun xaritada bosing.", ru: "Нажмите на карту, чтобы поставить метку.", en: "Tap the map to place the pin." },
  "cart.map_confirm": { uz: "Shu joyni tanlash", ru: "Выбрать эту точку", en: "Choose this spot" },
  ...
  "cart.map_geolocation_error": { uz: "Joriy joylashuvni topib bo'lmadi.", ru: "Не удалось определить текущее местоположение.", en: "Could not get current location." },
  "cart.map_reverse_error": { uz: "Aniq manzil topilmadi, lekin tanlangan nuqta saqlandi.", ru: "Точный адрес не найден, но точка сохранена.", en: "Exact address was not found, but the selected point was saved." },
  "cart.map_selected_title": { uz: "Tanlangan joy", ru: "Выбранное место", en: "Selected location" },
  ...
  "cart.deposit_preview": { uz: "Keyingi bosqichda chiqadi", ru: "Появится на следующем шаге", en: "Shown on the next step" },
  "cart.ready_title": { uz: "Buyurtma tayyor", ru: "Заказ готов", en: "Order is ready" },
  "cart.ready_description": { uz: "Hammasi tayyor. Keyingi bosqichda jami narxni ko'rasiz.", ru: "Все готово. На следующем шаге вы увидите итоговую сумму.", en: "Everything is ready. You will see the total on the next step." },
  "cart.continue_checkout": { uz: "Buyurtmani davom ettirish", ru: "Продолжить заказ", en: "Continue order" },

  "checkout.title": { uz: "Buyurtmani tasdiqlash", ru: "Подтверждение заказа", en: "Confirm order" },
  "checkout.subtitle": { uz: "Buyurtmani yuborishdan oldin jami narx va manzilni tekshiring.", ru: "Перед отправкой заказа проверьте итоговую сумму и адрес.", en: "Check the total and address before sending the order." },
  "checkout.unauth_subtitle": { uz: "Buyurtma yuborish uchun Telegram ichida oching.", ru: "Откройте внутри Telegram, чтобы отправить заказ.", en: "Open inside Telegram to place the order." },
  ...
  "checkout.address_required_description": { uz: "Savatcha sahifasida manzilni kiriting yoki xaritadan tanlang.", ru: "На странице корзины введите адрес или выберите его на карте.", en: "Enter the address or choose it on the map from the cart page." },
  "checkout.back_to_cart": { uz: "Savatchaga qaytish", ru: "Назад в корзину", en: "Back to cart" },
  "checkout.loading": { uz: "Buyurtma ma'lumotlari tayyorlanmoqda...", ru: "Подготавливаем данные заказа...", en: "Preparing order details..." },
  ...
  "checkout.create_order": { uz: "Buyurtmani yuborish", ru: "Отправить заказ", en: "Place order" },
  "checkout.creating_order": { uz: "Buyurtma yuborilmoqda...", ru: "Отправляем заказ...", en: "Placing order..." },
  "checkout.error_preview": { uz: "Buyurtma ma'lumotlarini ochib bo'lmadi.", ru: "Не удалось открыть данные заказа.", en: "Failed to load order details." },
  ...
  "orders.payment.subtitle": { uz: "Payme va Click orqali to'lov uchun havolalar.", ru: "Ссылки для оплаты через Payme и Click.", en: "Payment links for Payme and Click." },
