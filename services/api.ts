...
export const ENDPOINTS = {
  ...
  ORDERS: {
    ...
    CREATE_RECORDED: `${API_BASE_URL}/orders/create-recorded/`,
    EDIT: (id: string) => `${API_BASE_URL}/orders/${id}/edit/`,
    SOFT_DELETE: (id: string) => `${API_BASE_URL}/orders/${id}/delete/`,
  ...
  AI: {
    ...
    CREDENTIALS_HISTORY: `${API_BASE_URL}/ai/credentials/history/`,
  ...
  PAYMENTS: {
    ...
    CREATE_ORDER_ATTEMPT: (id: string) => `${API_BASE_URL}/orders/${id}/payments/attempts/create/`,
    ATTEMPT_CUSTOMER_CARD: (id: string) => `${API_BASE_URL}/payments/attempts/${id}/customer-card/`,
    ...
    CHECKOUT_CREATE: `${API_BASE_URL}/payments/checkout/create/`,
    CHECKOUT_SESSION: (id: string) => `${API_BASE_URL}/payments/checkout/sessions/${id}/`,
